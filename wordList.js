...
//to alphabetise this list automatically, run cmd from Windows Explorer in the local Voozo directory, and run node clean-list.js (make a backup wordList first)
